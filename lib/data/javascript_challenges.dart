...
int main() {
    printf("Hello, World!\n"''',
      ...
      {
        'slug': r'''javascript-integer-variable''',
        'language': r'''javascript''',
        'kind': r'''syntax''',
        'level': 6,
        'title': r'''정수 변수''',
...
int main() {
    for (int i = 1; i <= 10; i++) {
      ...
      {
        'slug': r'''javascript-array-declare''',
        'language': r'''javascript''',
        'kind': r'''basics''',
        'level': 31,
        'title': r'''배열 선언''',
...
int main() {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      {
        'slug': r'''javascript-pointer-address''',
        'language': r'''javascript''',
        'kind': r'''basics''',
        'level': 36,
        'title': r'''변수 주소 출력''',
...
int main() {
    ...
    printf("Value: %d\n", num''',
      ...
      {
        'slug': r'''javascript-struct-declare''',
        'language': r'''javascript''',
        'kind': r'''basics''',
        'level': 46,
        'title': r'''구조체 선언''',
