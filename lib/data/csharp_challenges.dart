...
class CsharpChallenges {
  static List<Map<String, dynamic>> getChallenges() {
    return [
      {
        'slug': r'''csharp-hello-world''',
        'language': r'''csharp''',
        'kind': r'''syntax''',
        'level': 1,
        'title': r'''Hello World''',
...
int main() {
    printf("Hello, World!\n"''',
      ...
      {
        'slug': r'''csharp-integer-variable''',
        'language': r'''csharp''',
        'kind': r'''syntax''',
        'level': 6,
        'title': r'''정수 변수''',
