/// TYPESCRIPT 챌린지 데이터 (총 7개)
/// SQL에서 자동 변환됨

class TypescriptChallenges {
  static List<Map<String, dynamic>> getChallenges() {
    return [
      {
        'slug': r'''typescript-hello-world''',
...
int main() {
    printf("Hello, World!\n"''',
      ...
      {
        'slug': r'''typescript-integer-variable''',
        'language': r'''typescript''',
        'kind': r'''syntax''',
        'level': 6,
        'title': r'''정수 변수''',
...
int main() {
    for (int i = 1; i <= 10; i++) {
      ...
      {
        'slug': r'''typescript-array-declare''',
        'language': r'''typescript''',
        'kind': r'''basics''',
        'level': 31,
        'title': r'''배열 선언''',
...
int main() {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      {
        'slug': r'''typescript-pointer-address''',
        'language': r'''typescript''',
        'kind': r'''basics''',
        'level': 36,
        'title': r'''변수 주소 출력''',
...
int main() {
    ...
    printf("Value: %d\n", num''',
      ...
      {
        'slug': r'''typescript-struct-declare''',
        'language': r'''typescript''',
        'kind': r'''basics''',
        'level': 46,
        'title': r'''구조체 선언''',
