-- ============================================================================
-- GO Language Challenges (Complete)
-- ============================================================================
-- Generated: 2025-11-01T14:07:10.152Z
-- ============================================================================

-- ============================================================================
-- Go Language Challenges - Part 1 (Easy)
-- ============================================================================
...
($$go-print-name$$, $$go$$, $$syntax$$, 2, $$이름 출력하기$$, $$자신의 이름을 출력하세요$$, $$challenge$$, 1,
...
($$go-multiline-output$$, $$go$$, $$syntax$$, 3, $$여러 줄 출력$$, $$여러 줄을 출력하세요$$, $$challenge$$, 1,
...
($$go-single-line-comment$$, $$go$$, $$syntax$$, 4, $$한 줄 주석$$, $$주석을 사용하여 코드 설명하기$$, $$challenge$$, 1,
...
($$go-multi-line-comment$$, $$go$$, $$syntax$$, 5, $$여러 줄 주석$$, $$여러 줄 주석 사용하기$$, $$challenge$$, 1,
...
($$go-float-variable$$, $$go$$, $$syntax$$, 7, $$실수 변수$$, $$실수형 변수 선언하고 출력하기$$, $$challenge$$, 1,
...
($$go-char-variable$$, $$go$$, $$syntax$$, 8, $$문자 변수$$, $$문자형 변수 선언하고 출력하기$$, $$challenge$$, 1,
...
($$go-multiple-variables$$, $$go$$, $$syntax$$, 9, $$여러 변수 선언$$, $$여러 개의 변수 선언하기$$, $$challenge$$, 1,
...
($$go-variable-swap$$, $$go$$, $$syntax$$, 10, $$변수값 교환$$, $$두 변수의 값 바꾸기$$, $$challenge$$, 1,
...
($$go-subtraction$$, $$go$$, $$basics$$, 12, $$뺄셈 계산$$, $$두 수의 차 구하기$$, $$challenge$$, 1,
...
($$go-multiplication$$, $$go$$, $$basics$$, 13, $$곱셈 계산$$, $$두 수의 곱 구하기$$, $$challenge$$, 1,
...
($$go-division$$, $$go$$, $$basics$$, 14, $$나눗셈 계산$$, $$두 수의 몫 구하기$$, $$challenge$$, 1,
...
($$go-modulo$$, $$go$$, $$basics$$, 15, $$나머지 계산$$, $$두 수의 나머지 구하기$$, $$challenge$$, 1,
...
($$go-if-else-even$$, $$go$$, $$basics$$, 17, $$짝수 홀수 판별$$, $$짝수인지 홀수인지 판별하기$$, $$challenge$$, 1,
...
($$go-if-else-max$$, $$go$$, $$basics$$, 18, $$두 수 중 큰 수$$, $$두 수 중 더 큰 수 찾기$$, $$challenge$$, 1,
...
($$go-if-else-if-grade$$, $$go$$, $$basics$$, 19, $$점수로 등급 판정$$, $$점수에 따라 등급 출력하기$$, $$challenge$$, 1,
...
($$go-logical-and$$, $$go$$, $$basics$$, 20, $$논리 연산 AND$$, $$두 조건이 모두 참인지 확인하기$$, $$challenge$$, 1,
...
($$go-while-countdown$$, $$go$$, $$basics$$, 22, $$카운트다운$$, $$while문으로 카운트다운하기$$, $$challenge$$, 1,
...
($$go-sum-1-to-n$$, $$go$$, $$basics$$, 23, $$1부터 N까지의 합$$, $$1부터 N까지의 합 구하기$$, $$challenge$$, 1,
...
($$go-multiplication-table$$, $$go$$, $$basics$$, 24, $$구구단$$, $$구구단 출력하기$$, $$challenge$$, 1,
...
($$go-do-while$$, $$go$$, $$basics$$, 25, $$do-while 반복$$, $$do-while문 사용하기$$, $$challenge$$, 1,
...
($$go-function-square$$, $$go$$, $$basics$$, 27, $$제곱 함수$$, $$숫자의 제곱을 구하는 함수 만들기$$, $$challenge$$, 1,
...
($$go-function-void$$, $$go$$, $$basics$$, 28, $$void 함수$$, $$반환값이 없는 함수 만들기$$, $$challenge$$, 1,
...
($$go-function-max$$, $$go$$, $$basics$$, 29, $$최댓값 함수$$, $$두 수 중 큰 수를 반환하는 함수$$, $$challenge$$, 1,
...
($$go-function-is-even$$, $$go$$, $$basics$$, 30, $$짝수 판별 함수$$, $$짝수인지 판별하는 함수$$, $$challenge$$, 1,
...
($$go-array-sum$$, $$go$$, $$basics$$, 32, $$배열 합계$$, $$배열 요소의 합 구하기$$, $$challenge$$, 1,
...
($$go-array-max$$, $$go$$, $$basics$$, 33, $$배열 최댓값$$, $$배열에서 가장 큰 값 찾기$$, $$challenge$$, 1,
...
($$go-array-reverse$$, $$go$$, $$basics$$, 34, $$배열 뒤집기$$, $$배열을 역순으로 출력하기$$, $$challenge$$, 1,
...
($$go-array-search$$, $$go$$, $$basics$$, 35, $$배열 검색$$, $$배열에서 특정 값 찾기$$, $$challenge$$, 1,
...
($$go-pointer-declare$$, $$go$$, $$basics$$, 37, $$포인터 선언$$, $$포인터 변수 선언하고 사용하기$$, $$challenge$$, 1,
...
($$go-pointer-modify$$, $$go$$, $$basics$$, 38, $$포인터로 값 수정$$, $$포인터를 통해 변수 값 변경하기$$, $$challenge$$, 1,
...
($$go-pointer-swap$$, $$go$$, $$basics$$, 39, $$포인터로 swap 함수$$, $$포인터를 이용한 swap 함수 만들기$$, $$challenge$$, 1,
...
($$go-pointer-array$$, $$go$$, $$basics$$, 40, $$포인터와 배열$$, $$포인터로 배열 접근하기$$, $$challenge$$, 1,
...
($$go-scanf-multiple$$, $$go$$, $$basics$$, 42, $$여러 값 입력받기$$, $$여러 개의 값을 한 번에 입력받기$$, $$challenge$$, 1,
...
($$go-printf-formatted$$, $$go$$, $$basics$$, 43, $$형식 지정 출력$$, $$printf로 형식을 지정하여 출력하기$$, $$challenge$$, 1,
...
($$go-getchar$$, $$go$$, $$basics$$, 44, $$문자 입력$$, $$getchar로 문자 입력받기$$, $$challenge$$, 1,
...
($$go-fgets$$, $$go$$, $$basics$$, 45, $$문자열 입력$$, $$fgets로 문자열 입력받기$$, $$challenge$$, 1,
...
($$go-struct-input$$, $$go$$, $$basics$$, 47, $$구조체 입력$$, $$구조체에 값 입력받기$$, $$challenge$$, 1,
...
($$go-struct-array$$, $$go$$, $$basics$$, 48, $$구조체 배열$$, $$구조체 배열 사용하기$$, $$challenge$$, 1,
...
($$go-struct-pointer$$, $$go$$, $$basics$$, 49, $$구조체 포인터$$, $$구조체 포인터 사용하기$$, $$challenge$$, 1,
...
($$go-struct-typedef$$, $$go$$, $$basics$$, 50, $$typedef 사용$$, $$typedef로 구조체 간단히 사용하기$$, $$challenge$$, 1,
...
-- ============================================================================
-- End of Go Language Part 1
-- ============================================================================

-- ============================================================================
-- Go Language Challenges - Part 2 (Medium & Hard)
-- ============================================================================
-- Total: 50 challenges (5 per unit × 10 units)
...
($$go-pyramid-pattern$$, $$go$$, $$syntax$$, 52, $$피라미드 패턴$$, $$공백과 별표로 피라미드 그리기$$, $$challenge$$, 2,
...
($$go-diamond-pattern$$, $$go$$, $$syntax$$, 53, $$다이아몬드 패턴$$, $$다이아몬드 모양 그리기$$, $$challenge$$, 2,
...
($$go-formatted-table$$, $$go$$, $$syntax$$, 54, $$테이블 형식 출력$$, $$정렬된 테이블 출력하기$$, $$challenge$$, 2,
...
($$go-ascii-art$$, $$go$$, $$syntax$$, 55, $$ASCII 아트$$, $$ASCII 문자로 그림 그리기$$, $$challenge$$, 2,
...
($$go-sizeof-types$$, $$go$$, $$basics$$, 57, $$자료형 크기$$, $$다양한 자료형의 크기 출력하기$$, $$challenge$$, 2,
...
($$go-type-casting$$, $$go$$, $$basics$$, 58, $$타입 캐스팅$$, $$명시적 타입 변환하기$$, $$challenge$$, 2,
...
($$go-const-variables$$, $$go$$, $$basics$$, 59, $$상수 사용$$, $$const 키워드로 상수 선언하기$$, $$challenge$$, 2,
...
($$go-enum-weekday$$, $$go$$, $$basics$$, 60, $$열거형 사용$$, $$enum으로 요일 표현하기$$, $$challenge$$, 2,
...
($$go-increment-decrement$$, $$go$$, $$basics$$, 62, $$증감 연산자$$, $$전위/후위 증감 연산자 이해하기$$, $$challenge$$, 2,
...
($$go-ternary-operator$$, $$go$$, $$basics$$, 63, $$삼항 연산자$$, $$조건 연산자로 간결한 코드 작성$$, $$challenge$$, 2,
...
($$go-bitwise-shift$$, $$go$$, $$basics$$, 64, $$비트 시프트$$, $$좌측/우측 시프트 연산$$, $$challenge$$, 2,
...
($$go-gcd-lcm$$, $$go$$, $$basics$$, 65, $$최대공약수와 최소공배수$$, $$GCD와 LCM 구하기$$, $$challenge$$, 2,
...
($$go-triangle-type$$, $$go$$, $$basics$$, 67, $$삼각형 종류$$, $$세 변의 길이로 삼각형 종류 판별$$, $$challenge$$, 2,
...
($$go-quadrant$$, $$go$$, $$basics$$, 68, $$사분면 판별$$, $$좌표의 사분면 결정하기$$, $$challenge$$, 2,
...
($$go-bmi-calculator$$, $$go$$, $$basics$$, 69, $$BMI 계산기$$, $$체질량지수로 비만도 판정$$, $$challenge$$, 2,
...
($$go-switch-calculator$$, $$go$$, $$basics$$, 70, $$Switch 계산기$$, $$switch문으로 계산기 만들기$$, $$challenge$$, 2,
...
($$go-prime-check$$, $$go$$, $$basics$$, 72, $$소수 판별$$, $$소수인지 확인하기$$, $$challenge$$, 2,
...
($$go-digit-sum$$, $$go$$, $$basics$$, 73, $$자릿수 합$$, $$각 자릿수의 합 구하기$$, $$challenge$$, 2,
...
($$go-reverse-number$$, $$go$$, $$basics$$, 74, $$숫자 뒤집기$$, $$숫자를 거꾸로 만들기$$, $$challenge$$, 2,
...
($$go-collatz-conjecture$$, $$go$$, $$basics$$, 75, $$콜라츠 추측$$, $$1이 될 때까지의 단계 수$$, $$challenge$$, 2,
...
($$go-recursive-fibonacci$$, $$go$$, $$basics$$, 77, $$재귀 피보나치$$, $$재귀 함수로 피보나치 수 구하기$$, $$challenge$$, 2,
...
($$go-power-function$$, $$go$$, $$basics$$, 78, $$거듭제곱 함수$$, $$base^exponent 계산하기$$, $$challenge$$, 2,
...
($$go-array-function$$, $$go$$, $$basics$$, 79, $$배열 함수$$, $$배열을 함수로 전달하기$$, $$challenge$$, 2,
...
($$go-pass-by-reference$$, $$go$$, $$basics$$, 80, $$참조로 전달$$, $$포인터로 값 변경하기$$, $$challenge$$, 2,
...
($$go-binary-search$$, $$go$$, $$advanced$$, 82, $$이진 탐색$$, $$정렬된 배열에서 값 찾기$$, $$challenge$$, 3,
...
($$go-2d-array-transpose$$, $$go$$, $$advanced$$, 83, $$행렬 전치$$, $$2차원 배열 전치하기$$, $$challenge$$, 3,
...
($$go-array-rotation$$, $$go$$, $$advanced$$, 84, $$배열 회전$$, $$배열을 K번 회전하기$$, $$challenge$$, 3,
...
($$go-subarray-sum$$, $$go$$, $$advanced$$, 85, $$부분 배열 합$$, $$연속된 부분 배열의 최대 합$$, $$challenge$$, 3,
...
($$go-double-pointer$$, $$go$$, $$advanced$$, 87, $$이중 포인터$$, $$포인터의 포인터 사용하기$$, $$challenge$$, 3,
...
($$go-function-pointer$$, $$go$$, $$advanced$$, 88, $$함수 포인터$$, $$함수 포인터로 연산 선택$$, $$challenge$$, 3,
...
($$go-dynamic-array$$, $$go$$, $$advanced$$, 89, $$동적 배열$$, $$malloc으로 동적 메모리 할당$$, $$challenge$$, 3,
...
($$go-linked-list-basics$$, $$go$$, $$advanced$$, 90, $$연결 리스트 기초$$, $$단순 연결 리스트 구현$$, $$challenge$$, 3,
...
($$go-file-read$$, $$go$$, $$advanced$$, 92, $$파일 읽기$$, $$파일에서 텍스트 읽기$$, $$challenge$$, 3,
...
($$go-file-copy$$, $$go$$, $$advanced$$, 93, $$파일 복사$$, $$파일 내용을 다른 파일로 복사$$, $$challenge$$, 3,
...
($$go-file-word-count$$, $$go$$, $$advanced$$, 94, $$파일 단어 수$$, $$파일의 단어 개수 세기$$, $$challenge$$, 3,
...
($$go-binary-file$$, $$go$$, $$advanced$$, 95, $$바이너리 파일$$, $$구조체를 바이너리 파일로 저장$$, $$challenge$$, 3,
...
($$go-palindrome-check$$, $$go$$, $$advanced$$, 97, $$회문 검사$$, $$회문인지 확인하기$$, $$challenge$$, 3,
...
($$go-string-tokenize$$, $$go$$, $$advanced$$, 98, $$문자열 토큰화$$, $$공백으로 문자열 나누기$$, $$challenge$$, 3,
...
($$go-anagram-check$$, $$go$$, $$advanced$$, 99, $$애너그램 검사$$, $$두 문자열이 애너그램인지 확인$$, $$challenge$$, 3,
...
($$go-substring-search$$, $$go$$, $$advanced$$, 100, $$부분 문자열 찾기$$, $$문자열 내 부분 문자열 위치 찾기$$, $$challenge$$, 3,
