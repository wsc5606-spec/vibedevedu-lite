...
INSERT INTO challenges (slug, language, kind, level, title, description, category, difficulty, problem_description, constraints, examples, initial_code, solution_code, test_cases, hints, tags, estimated_time) VALUES
($$html-required$$, $$html$$, $$syntax$$, 61, $$필수 입력$$, $$required 작성$$, $$challenge$$, 2,
$$필수 입력 필드를 만드세요.$$,
$$- required 작성\n- 제출 시 자동 검증$$,
$$[{"input": "", "output": "필수 필드"}]$$,
...
$$페이스북/SNS 공유를 위한 Open Graph 태그를 추가하세요.$$,
...
$$["border 속성은 HTML5에서는 CSS은 사용하는 것이 권장됩니다"]$$,
$$["table", "border"]$$, 5),
...
INSERT INTO challenges (slug, language, kind, level, title, description, category, difficulty, problem_description, constraints, examples, initial_code, solution_code, test_cases, hints, tags, estimated_time) VALUES
($$html-aria-label$$, $$html$$, $$syntax$$, 76, $$ARIA 라벨$$, $$aria-label 작성$$, $$challenge$$, 3,
$$스크린 리더은 위한 ARIA 라벨을 추가하세요.$$,
$$- aria-label 작성\n- 시각적 텍스트가 없는 요소개$$,
...
$$/* 모든 p 태그를 파란색으로 */\n$$,
$$p {\n    color: blue;\n}$$,
$$[{"input": "", "expected": "blue paragraphs"}]$$,
$$["요소 선택자는 해당 태그 모두에 적용됩니다"]$$,
$$["selectors", "element"]$$, 3);
...
$$["flex-wrap: wrap으로 아이템이 여러 줄로 배치됩니다"]$$,
$$["flexbox", "wrap"]$$, 8);
...
$$Hello를 출력하는 코드를 작성하고, 태그 위에 한 줄 주석으로 "이것은 출력 코드입니다"은 추가하세요.$$,
$$- // 은 사용하여 주석을 작성하세요$$,
$$[{"input": "", "output": "Hello"}]$$,
$func$
    // 여기에 주석과 코드를 작성하세요
