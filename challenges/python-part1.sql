...
('python-float-variable', 'python', 'syntax', 7, '?�수 변??, '?�수??변???�언?�고 출력?�기', 'challenge', 1,
...
('python-char-variable', 'python', 'syntax', 8, '문자 변??, '문자??변???�언?�고 출력?�기', 'challenge', 1,
...
('python-multiple-variables', 'python', 'syntax', 9, '?�러 변???�언', '?�러 개의 변???�언?�기', 'challenge', 1,
...
('python-variable-swap', 'python', 'syntax', 10, '변?�값 교환', '??변?�의 �?바꾸�?, 'challenge', 1,
...
('python-subtraction', 'python', 'basics', 12, '뺄셈 계산', '???�의 �?구하�?, 'challenge', 1,
...
('python-multiplication', 'python', 'basics', 13, '곱셈 계산', '???�의 �?구하�?, 'challenge', 1,
...
('python-division', 'python', 'basics', 14, '?�눗??계산', '???�의 �?구하�?, 'challenge', 1,
...
('python-modulo', 'python', 'basics', 15, '?�머지 계산', '???�의 ?�머지 구하�?, 'challenge', 1,
...
('python-if-else-even', 'python', 'basics', 17, '짝수 ?�???�별', '짝수?��? ?�?�인지 ?�별?�기', 'challenge', 1,
...
('python-if-else-max', 'python', 'basics', 18, '????�?????, '????�???????찾기', 'challenge', 1,
'???�수 a, b가 주어�??? ?????��? 출력?�세??',
'- if-else 문을 ?�용?�세??,
...
('python-if-else-if-grade', 'python', 'basics', 19, '?�수�??�급 ?�정', '?�수???�라 ?�급 출력?�기', 'challenge', 1,
...
('python-logical-and', 'python', 'basics', 20, '?�리 ?�산 AND', '??조건??모두 참인지 ?�인?�기', 'challenge', 1,
...
('python-while-countdown', 'python', 'basics', 22, '카운?�다??, 'while문으�?카운?�다?�하�?, 'challenge', 1,
...
('python-sum-1-to-n', 'python', 'basics', 23, '1부??N까�?????, '1부??N까�?????구하�?, 'challenge', 1,
...
('python-multiplication-table', 'python', 'basics', 24, '구구??, '구구??출력?�기', 'challenge', 1,
...
('python-do-while', 'python', 'basics', 25, 'do-while 반복', 'do-while�??�용?�기', 'challenge', 1,
...
('python-function-square', 'python', 'basics', 27, '?�곱 ?�수', '?�자???�곱??구하???�수 만들�?, 'challenge', 1,
...
('python-function-void', 'python', 'basics', 28, 'void ?�수', '반환값이 ?�는 ?�수 만들�?, 'challenge', 1,
...
('python-function-max', 'python', 'basics', 29, '최댓�??�수', '????�????��? 반환?�는 ?�수', 'challenge', 1,
'???�수 �???값을 반환?�는 max ?�수�??�성?�세??',
'- if-else�??�용?�세??,
...
('python-function-is-even', 'python', 'basics', 30, '짝수 ?�별 ?�수', '짝수?��? ?�별?�는 ?�수', 'challenge', 1,
...
('python-array-sum', 'python', 'basics', 32, '배열 ?�계', '배열 ?�소????구하�?, 'challenge', 1,
...
('python-array-max', 'python', 'basics', 33, '배열 최댓�?, '배열?�서 가????�?찾기', 'challenge', 1,
...
('python-array-reverse', 'python', 'basics', 34, '배열 ?�집�?, '배열????��?�로 출력?�기', 'challenge', 1,
'?�기가 5??배열???�력받아 ??��?�로 출력?�세??',
'- for문을 ??��?�로 ?�리?�요',
...
('python-array-search', 'python', 'basics', 35, '배열 검??, '배열?�서 ?�정 �?찾기', 'challenge', 1,
...
('python-pointer-declare', 'python', 'basics', 37, '?�인???�언', '?�인??변???�언?�고 ?�용?�기', 'challenge', 1,
...
('python-pointer-modify', 'python', 'basics', 38, '?�인?�로 �??�정', '?�인?��? ?�해 변??�?변경하�?, 'challenge', 1,
...
('python-pointer-swap', 'python', 'basics', 39, '?�인?�로 swap ?�수', '?�인?��? ?�용??swap ?�수 만들�?, 'challenge', 1,
...
('python-pointer-array', 'python', 'basics', 40, '?�인?��? 배열', '?�인?�로 배열 ?�근?�기', 'challenge', 1,
...
('python-scanf-multiple', 'python', 'basics', 42, '?�러 �??�력받기', '?�러 개의 값을 ??번에 ?�력받기', 'challenge', 1,
'??개의 ?�수�??�력받아 ?�을 출력?�세??',
'- scanf("%d %d %d", &a, &b, &c);',
...
('python-printf-formatted', 'python', 'basics', 43, '?�식 지??출력', 'printf�??�식??지?�하??출력?�기', 'challenge', 1,
...
('python-getchar', 'python', 'basics', 44, '문자 ?�력', 'getchar�?문자 ?�력받기', 'challenge', 1,
'문자 ?�나�??�력받아 그�?�?출력?�세??',
'- char ch = getchar();',
'[{"input": "A", "output": "A"}]',
'
...
('python-fgets', 'python', 'basics', 45, '문자???�력', 'fgets�?문자???�력받기', 'challenge', 1,
'??줄의 문자?�을 ?�력받아 그�?�?출력?�세??',
...
('python-struct-input', 'python', 'basics', 47, '구조�??�력', '구조체에 �??�력받기', 'challenge', 1,
...
('python-struct-array', 'python', 'basics', 48, '구조�?배열', '구조�?배열 ?�용?�기', 'challenge', 1,
...
('python-struct-pointer', 'python', 'basics', 49, '구조�??�인??, '구조�??�인???�용?�기', 'challenge', 1,
...
('python-struct-typedef', 'python', 'basics', 50, 'typedef ?�용', 'typedef�?구조�?간단???�용?�기', 'challenge', 1,
