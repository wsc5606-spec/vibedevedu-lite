...
('javascript-print-name', 'javascript', 'syntax', 2, '?�름 출력?�기', '?�신???�름??출력?�세??, 'challenge', 1,
...
('javascript-multiline-output', 'javascript', 'syntax', 3, '?�러 �?출력', '?�러 줄을 출력?�세??, 'challenge', 1,
'?�음 ??줄을 출력?�는 ?�로그램???�성?�세??\nLine 1\nLine 2\nLine 3',
'- �?줄�? ?�로??줄에 출력?�어???�니??,
'[{"input": "", "output": "Line 1\nLine 2\nLine 3"}]',
'#include <stdio.h>
...
('javascript-single-line-comment', 'javascript', 'syntax', 4, '??�?주석', '주석???�용?�여 코드 ?�명?�기', 'challenge', 1,
...
('javascript-multi-line-comment', 'javascript', 'syntax', 5, '?�러 �?주석', '?�러 �?주석 ?�용?�기', 'challenge', 1,
...
('javascript-float-variable', 'javascript', 'syntax', 7, '?�수 변??, '?�수??변???�언?�고 출력?�기', 'challenge', 1,
...
('javascript-char-variable', 'javascript', 'syntax', 8, '문자 변??, '문자??변???�언?�고 출력?�기', 'challenge', 1,
...
('javascript-multiple-variables', 'javascript', 'syntax', 9, '?�러 변???�언', '?�러 개의 변???�언?�기', 'challenge', 1,
...
('javascript-variable-swap', 'javascript', 'syntax', 10, '변?�값 교환', '??변?�의 �?바꾸�?, 'challenge', 1,
...
('javascript-subtraction', 'javascript', 'basics', 12, '뺄셈 계산', '???�의 �?구하�?, 'challenge', 1,
...
('javascript-multiplication', 'javascript', 'basics', 13, '곱셈 계산', '???�의 �?구하�?, 'challenge', 1,
...
('javascript-division', 'javascript', 'basics', 14, '?�눗??계산', '???�의 �?구하�?, 'challenge', 1,
...
('javascript-modulo', 'javascript', 'basics', 15, '?�머지 계산', '???�의 ?�머지 구하�?, 'challenge', 1,
...
('javascript-if-else-even', 'javascript', 'basics', 17, '짝수 ?�???�별', '짝수?��? ?�?�인지 ?�별?�기', 'challenge', 1,
...
('javascript-if-else-max', 'javascript', 'basics', 18, '????�?????, '????�???????찾기', 'challenge', 1,
'???�수 a, b가 주어�??? ?????��? 출력?�세??',
'- if-else 문을 ?�용?�세??,
...
('javascript-if-else-if-grade', 'javascript', 'basics', 19, '?�수�??�급 ?�정', '?�수???�라 ?�급 출력?�기', 'challenge', 1,
...
('javascript-logical-and', 'javascript', 'basics', 20, '?�리 ?�산 AND', '??조건??모두 참인지 ?�인?�기', 'challenge', 1,
...
('javascript-while-countdown', 'javascript', 'basics', 22, '카운?�다??, 'while문으�?카운?�다?�하�?, 'challenge', 1,
...
('javascript-sum-1-to-n', 'javascript', 'basics', 23, '1부??N까�?????, '1부??N까�?????구하�?, 'challenge', 1,
...
('javascript-multiplication-table', 'javascript', 'basics', 24, '구구??, '구구??출력?�기', 'challenge', 1,
...
('javascript-do-while', 'javascript', 'basics', 25, 'do-while 반복', 'do-while�??�용?�기', 'challenge', 1,
...
('javascript-function-square', 'javascript', 'basics', 27, '?�곱 ?�수', '?�자???�곱??구하???�수 만들�?, 'challenge', 1,
...
('javascript-function-void', 'javascript', 'basics', 28, 'void ?�수', '반환값이 ?�는 ?�수 만들�?, 'challenge', 1,
...
('javascript-function-max', 'javascript', 'basics', 29, '최댓�??�수', '????�????��? 반환?�는 ?�수', 'challenge', 1,
'???�수 �???값을 반환?�는 max ?�수�??�성?�세??',
'- if-else�??�용?�세??,
...
('javascript-function-is-even', 'javascript', 'basics', 30, '짝수 ?�별 ?�수', '짝수?��? ?�별?�는 ?�수', 'challenge', 1,
...
('javascript-array-sum', 'javascript', 'basics', 32, '배열 ?�계', '배열 ?�소????구하�?, 'challenge', 1,
...
('javascript-array-max', 'javascript', 'basics', 33, '배열 최댓�?, '배열?�서 가????�?찾기', 'challenge', 1,
...
('javascript-array-reverse', 'javascript', 'basics', 34, '배열 ?�집�?, '배열????��?�로 출력?�기', 'challenge', 1,
'?�기가 5??배열???�력받아 ??��?�로 출력?�세??',
'- for문을 ??��?�로 ?�리?�요',
...
('javascript-array-search', 'javascript', 'basics', 35, '배열 검??, '배열?�서 ?�정 �?찾기', 'challenge', 1,
...
('javascript-pointer-declare', 'javascript', 'basics', 37, '?�인???�언', '?�인??변???�언?�고 ?�용?�기', 'challenge', 1,
...
('javascript-pointer-modify', 'javascript', 'basics', 38, '?�인?�로 �??�정', '?�인?��? ?�해 변??�?변경하�?, 'challenge', 1,
...
('javascript-pointer-swap', 'javascript', 'basics', 39, '?�인?�로 swap ?�수', '?�인?��? ?�용??swap ?�수 만들�?, 'challenge', 1,
...
('javascript-pointer-array', 'javascript', 'basics', 40, '?�인?��? 배열', '?�인?�로 배열 ?�근?�기', 'challenge', 1,
...
('javascript-scanf-multiple', 'javascript', 'basics', 42, '?�러 �??�력받기', '?�러 개의 값을 ??번에 ?�력받기', 'challenge', 1,
'??개의 ?�수�??�력받아 ?�을 출력?�세??',
'- scanf("%d %d %d", &a, &b, &c);',
...
('javascript-printf-formatted', 'javascript', 'basics', 43, '?�식 지??출력', 'printf�??�식??지?�하??출력?�기', 'challenge', 1,
...
('javascript-getchar', 'javascript', 'basics', 44, '문자 ?�력', 'getchar�?문자 ?�력받기', 'challenge', 1,
'문자 ?�나�??�력받아 그�?�?출력?�세??',
'- char ch = getchar();',
'[{"input": "A", "output": "A"}]',
'#include <stdio.h>
...
('javascript-fgets', 'javascript', 'basics', 45, '문자???�력', 'fgets�?문자???�력받기', 'challenge', 1,
'??줄의 문자?�을 ?�력받아 그�?�?출력?�세??',
...
('javascript-struct-input', 'javascript', 'basics', 47, '구조�??�력', '구조체에 �??�력받기', 'challenge', 1,
...
('javascript-struct-array', 'javascript', 'basics', 48, '구조�?배열', '구조�?배열 ?�용?�기', 'challenge', 1,
...
('javascript-struct-pointer', 'javascript', 'basics', 49, '구조�??�인??, '구조�??�인???�용?�기', 'challenge', 1,
...
('javascript-struct-typedef', 'javascript', 'basics', 50, 'typedef ?�용', 'typedef�?구조�?간단???�용?�기', 'challenge', 1,
