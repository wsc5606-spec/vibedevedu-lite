...
('go-pyramid-pattern', 'go', 'syntax', 52, '?�라미드 ?�턴', '공백�?별표�??�라미드 그리�?, 'challenge', 2,
'?�수 N??주어�??? N줄의 ?�라미드�?출력?�세??\n?? N=3????n  *\n ***\n*****',
'- 공백�?별표 계산 ?�요\n- 1 ??N ??10',
'[{"input": "3", "output": "  *\n ***\n*****"}]',
'#include <stdio.h>
...
('go-diamond-pattern', 'go', 'syntax', 53, '?�이?�몬???�턴', '?�이?�몬??모양 그리�?, 'challenge', 2,
'?�??N??주어�??? N줄의 ?�이?�몬?��? 출력?�세??',
'- ?�단 ?�반�??�단 ?�반?�로 ?�누???�각\n- N?� ?�??,
'[{"input": "5", "output": "  *\n ***\n*****\n ***\n  *"}]',
'#include <stdio.h>
...
('go-formatted-table', 'go', 'syntax', 54, '?�이�??�식 출력', '?�렬???�이�?출력?�기', 'challenge', 2,
...
('go-ascii-art', 'go', 'syntax', 55, 'ASCII ?�트', 'ASCII 문자�?그림 그리�?, 'challenge', 2,
'?�력받�? 문자�?5x5 ?�각???�두리�? 그리?�요.',
'- ?�두리만 ?�력 문자�? ?��???공백',
'[{"input": "#", "output": "#####\n#   #\n#   #\n#   #\n#####"}]',
'#include <stdio.h>
...
('go-sizeof-types', 'go', 'basics', 57, '?�료???�기', '?�양???�료?�의 ?�기 출력?�기', 'challenge', 2,
...
('go-type-casting', 'go', 'basics', 58, '?�??캐스??, '명시???�??변?�하�?, 'challenge', 2,
...
('go-const-variables', 'go', 'basics', 59, '?�수 ?�용', 'const ?�워?�로 ?�수 ?�언?�기', 'challenge', 2,
...
('go-enum-weekday', 'go', 'basics', 60, '?�거???�용', 'enum?�로 ?�일 ?�현?�기', 'challenge', 2,
...
('go-increment-decrement', 'go', 'basics', 62, '증감 ?�산??, '?�위/?�위 증감 ?�산???�해?�기', 'challenge', 2,
...
('go-ternary-operator', 'go', 'basics', 63, '?�항 ?�산??, '조건 ?�산?�로 간결??코드 ?�성', 'challenge', 2,
...
('go-bitwise-shift', 'go', 'basics', 64, '비트 ?�프??, '좌측/?�측 ?�프???�산', 'challenge', 2,
...
('go-gcd-lcm', 'go', 'basics', 65, '최�?공약?��? 최소공배??, 'GCD?� LCM 구하�?, 'challenge', 2,
...
('go-triangle-type', 'go', 'basics', 67, '?�각??종류', '??변??길이�??�각??종류 ?�별', 'challenge', 2,
...
('go-quadrant', 'go', 'basics', 68, '?�분�??�별', '좌표???�분�?결정?�기', 'challenge', 2,
...
('go-bmi-calculator', 'go', 'basics', 69, 'BMI 계산�?, '체질?��??�로 비만???�정', 'challenge', 2,
...
('go-switch-calculator', 'go', 'basics', 70, 'Switch 계산�?, 'switch문으�?계산�?만들�?, 'challenge', 2,
...
('go-prime-check', 'go', 'basics', 72, '?�수 ?�별', '?�수?��? ?�인?�기', 'challenge', 2,
...
('go-digit-sum', 'go', 'basics', 73, '?�릿????, '�??�릿?�의 ??구하�?, 'challenge', 2,
'?�수 N??주어�??? �??�릿?�의 ?�을 구하?�요.',
'- % 10?�로 마�?�??�리 추출\n- / 10?�로 ?�릿???�거',
...
('go-reverse-number', 'go', 'basics', 74, '?�자 ?�집�?, '?�자�?거꾸�?만들�?, 'challenge', 2,
'?�수 N??주어�??? ?�릿?��? 거꾸�??�집?� ?��? 출력?�세??',
'- 1230 ??321 (?�의 0?� 무시)',
...
('go-collatz-conjecture', 'go', 'basics', 75, '콜라�?추측', '1?????�까지???�계 ??, 'challenge', 2,
'?�수 N??주어�??? 1?????�까지???�계 ?��? 출력?�세??\n짝수: N/2, ?�?? 3N+1',
'- N ??1',
'[{"input": "6", "output": "8"}]',
'#include <stdio.h>
...
('go-recursive-fibonacci', 'go', 'basics', 77, '?��? ?�보?�치', '?��? ?�수�??�보?�치 ??구하�?, 'challenge', 2,
'?��? ?�수�??�용?�여 N번째 ?�보?�치 ?��? 구하?�요.',
'- int fib(int n)\n- ?��? ?�출',
'[{"input": "7", "output": "13"}]',
'#include <stdio.h>
...
('go-power-function', 'go', 'basics', 78, '거듭?�곱 ?�수', 'base^exponent 계산?�기', 'challenge', 2,
...
('go-array-function', 'go', 'basics', 79, '배열 ?�수', '배열???�수�??�달?�기', 'challenge', 2,
...
('go-pass-by-reference', 'go', 'basics', 80, '참조�??�달', '?�인?�로 �?변경하�?, 'challenge', 2,
'???�수???�과 차�? ?�시??구하???�수�??�성?�세??',
...
('go-binary-search', 'go', 'advanced', 82, '?�진 ?�색', '?�렬??배열?�서 �?찾기', 'challenge', 3,
...
('go-2d-array-transpose', 'go', 'advanced', 83, '?�렬 ?�치', '2차원 배열 ?�치?�기', 'challenge', 3,
...
('go-array-rotation', 'go', 'advanced', 84, '배열 ?�전', '배열??K�??�전?�기', 'challenge', 3,
'N개의 ?�수 배열???�쪽?�로 K�??�전?�세??',
...
('go-subarray-sum', 'go', 'advanced', 85, '부�?배열 ??, '?�속??부�?배열??최�? ??, 'challenge', 3,
...
('go-double-pointer', 'go', 'advanced', 87, '?�중 ?�인??, '?�인?�의 ?�인???�용?�기', 'challenge', 3,
...
('go-function-pointer', 'go', 'advanced', 88, '?�수 ?�인??, '?�수 ?�인?�로 ?�산 ?�택', 'challenge', 3,
'?�수 ?�인?��? ?�용?�여 ?�칙?�산???�택?�으�??�행?�세??',
...
('go-dynamic-array', 'go', 'advanced', 89, '?�적 배열', 'malloc?�로 ?�적 메모�??�당', 'challenge', 3,
...
('go-linked-list-basics', 'go', 'advanced', 90, '?�결 리스??기초', '?�순 ?�결 리스??구현', 'challenge', 3,
...
('go-file-read', 'go', 'advanced', 92, '?�일 ?�기', '?�일?�서 ?�스???�기', 'challenge', 3,
...
('go-file-copy', 'go', 'advanced', 93, '?�일 복사', '?�일 ?�용???�른 ?�일�?복사', 'challenge', 3,
...
('go-file-word-count', 'go', 'advanced', 94, '?�일 ?�어 ??, '?�일???�어 개수 ?�기', 'challenge', 3,
...
('go-binary-file', 'go', 'advanced', 95, '바이?�리 ?�일', '구조체�? 바이?�리 ?�일�??�??, 'challenge', 3,
...
('go-palindrome-check', 'go', 'advanced', 97, '?�문 검??, '?�문?��? ?�인?�기', 'challenge', 3,
...
('go-string-tokenize', 'go', 'advanced', 98, '문자???�큰??, '공백?�로 문자???�누�?, 'challenge', 3,
...
('go-anagram-check', 'go', 'advanced', 99, '?�너그램 검??, '??문자?�이 ?�너그램?��? ?�인', 'challenge', 3,
...
('go-substring-search', 'go', 'advanced', 100, '부�?문자??찾기', '문자????부�?문자???�치 찾기', 'challenge', 3,
